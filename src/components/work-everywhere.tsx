...
export function WorkEverywhere() {
  return (
    <section className="relative  py-10 my-10 bg-primary overflow-clip text-primary-foreground flex flex-col gap-10 items-center justify-center">
      <Image src="/images/shape1.png" width={400} height={600} alt="shape" className="absolute left-0 opacity-25"/>
      <div className="w-full max-w-[1250px] py-20 flex flex-col gap-3 justify-center items-center ">
