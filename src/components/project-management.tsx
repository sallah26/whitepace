...
export function ProjectManagement() {
  return (
    <section className="relative py-6 bg-background text-foreground flex flex-col gap-10 items-center justify-center">
      <Image src="/images/shape5.png" width={400} height={400} alt="shape" className="absolute z-0 left-0 opacity-20"/>
      
      <div className="w-full max-w-[1250px] py-16 flex flex-col lg:flex-row gap-0 justify-center items-center ">
