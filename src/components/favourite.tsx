...
export function Favorite() {
  return (
    <section className="bg-primary p-4 text-primary-foreground py-7 flex flex-col gap-10 items-center justify-center ">
      <Image src="/images/shape2.png" width={400} height={600} alt="shape" className="absolute w-screen object-cover left-0 "/>
      <div className="w-full max-w-[1250px] py-4 md:py-10 flex flex-col-reverse lg:flex-row gap-10 justify-center items-center ">
      <div className="relative w-full h-full lg:w-1/2 flex justify-center ">
          <Image src="/images/Apps.png"  width={700} height={700} alt="shape" className="w-full md:w-[90%]  h-full"/>
        </div>
