...
export function WorkTogether() {
  return (
    <section className="py-10 bg-background p-4 text-foreground flex flex-col gap-10 items-center justify-center">
      
      <div className="w-full max-w-[1250px] py-0 flex flex-col-reverse lg:flex-row gap-4 justify-center items-center ">
      <div className="relative w-full h-full lg:w-1/2 flex justify-center ">
          <Image src="/images/peoples.png"  width={700} height={700} alt="shape" className="w-full md:w-[80%]  h-full"/>
        </div>
      ...
      <Image src="/images/shape4.png" width={400} height={20} alt="shape" className="   left-0 z-10 -mt-2"/>
          ...
          <p className="text-md md:text-lg max-w-xl z-20">
